    ...
    with click_spinner.spinner():
        for computer in computers:
            ...
            try:
                ...
                results.append(
                    service_result(computer_label, service_name, state, Messages.SUCCESS, "Service has been restarted.")
                )

            except Exception as err:
                results.append(
                    service_result(
                        computer_label, service_name, state, Messages.ERROR, "unable to restart the service."
                    )
                )
    ...
    with click_spinner.spinner():
        for computer in computers:
            ...
            try:
                ...
                results.append(
                    service_result(computer_label, service_name, state, Messages.SUCCESS, "Service has been started.")
                )

            except Exception as err:
                results.append(
                    service_result(computer_label, service_name, state, Messages.ERROR, "unable to start the service.")
                )
    ...
    with click_spinner.spinner():
        for computer in computers:
            ...
            try:
                ...
                results.append(
                    service_result(computer_label, service_name, state, Messages.SUCCESS, "Service has been stopped.")
                )

            except Exception as err:
                results.append(
                    service_result(computer_label, service_name, state, Messages.ERROR, "unable to stop the service.")
                )
    ...
    with click_spinner.spinner():
        for computer in computers:
            ...
            try:
                ...
                results.append(
                    service_result(computer_label, service_name, state, Messages.SUCCESS, "Current service state")
                )
    ...
    with click_spinner.spinner():
        for computer in computers:
            ...
            try:
                ...
                results.append(
                    service_result(computer_label, service_name, state, Messages.SUCCESS, "Service has been deployed.")
                )

            except Exception as err:
                results.append(
                    service_result(computer_label, service_name, state, Messages.ERROR, "unable to deploy the service.")
                )
